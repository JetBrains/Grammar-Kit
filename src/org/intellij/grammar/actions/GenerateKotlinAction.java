...
public class GenerateKotlinAction extends AnAction {
  private static final Logger LOG = Logger.getInstance(GenerateKotlinAction.class);
        ...
        for (int i = 0, l = bnfFiles.size(); i < l; i++) {
          ...
          try {
            DumbService.getInstance(project).runReadActionInSmartMode(() -> {
              ...
              final var generator = new KotlinParserGenerator((BnfFile)bnfFile, sourcePath, genDir.getPath(), packagePrefix) {
                @Override
  ...
  protected static @Nullable PsiFile getBnfFile(VirtualFile file, PsiManager psiManager) {
