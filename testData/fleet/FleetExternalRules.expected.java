...
// ---- FleetExternalRules.java -----------------
// This is a generated file. Not intended for manual editing.
package fleet;

import fleet.com.intellij.lang.PsiBuilder;
import fleet.com.intellij.lang.PsiBuilder.Marker;
import static fleet.generated.GeneratedTypes.*;
import static fleet.org.intellij.grammar.test.ParserUtil.*;
...
public class FleetExternalRules implements PsiParser, LightPsiParser {
  ...
  static boolean parse_root_(IElementType root_, PsiBuilder builder_, int level_) {
    boolean result_;
    if (root_ == EXTRA_ROOT) {
      result_ = FleetExternalRules2.extra_root(builder_, level_ + 1);
    }
    else {
  ...
  public static boolean collapse_one(PsiBuilder builder_, int level_) {
    ...
    result_ = uniqueListOf(builder_, level_ + 1, FleetExternalRules::one);
  ...
  static boolean meta_mixed_list_paren(PsiBuilder builder_, int level_) {
    return meta_mixed(builder_, level_ + 1, FleetExternalRules::meta_mixed_list_paren_0_0);
  }

  // <<comma_list one>>
  private static boolean meta_mixed_list_paren_0_0(PsiBuilder builder_, int level_) {
    return comma_list(builder_, level_ + 1, FleetExternalRules::one);
  }

  /* ********************************************************** */
  // <<meta_mixed statement>>
  static boolean meta_mixed_simple(PsiBuilder builder_, int level_) {
    return meta_mixed(builder_, level_ + 1, FleetExternalRules::statement);
  }
  ...
  static boolean meta_seq(PsiBuilder builder_, int level_) {
    return comma_list_pinned(builder_, level_ + 1, FleetExternalRules::one, FleetExternalRules::meta_seq_0_1);
  }
  ...
  static boolean meta_seq_of_lists(PsiBuilder builder_, int level_) {
    return list_of_lists(builder_, level_ + 1, FleetExternalRules::one, FleetExternalRules::meta_seq_of_lists_0_1);
  }
  ...
  private static boolean meta_seq_of_lists_opt_0(PsiBuilder builder_, int level_) {
    return list_of_lists(builder_, level_ + 1, FleetExternalRules::one, FleetExternalRules::meta_seq_of_lists_opt_0_0_1);
  }
  ...
  static boolean multi_level(PsiBuilder builder_, int level_) {
    return meta_multi_level(builder_, level_ + 1, FleetExternalRules::one);
  }
  ...
  static boolean param_choice(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && uniqueListOf(builder_, level_ + 1, FleetExternalRules::param_choice_1_0);
  ...
  static boolean param_choice_alt(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, "{");
    result_ = result_ && uniqueListOf(builder_, level_ + 1, FleetExternalRules::param_choice_alt_1_0);
    result_ = result_ && consumeToken(builder_, "}");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  static boolean param_opt(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, "{");
    result_ = result_ && uniqueListOf(builder_, level_ + 1, FleetExternalRules::param_opt_1_0);
    result_ = result_ && consumeToken(builder_, "}");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  static boolean param_seq(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, "{");
    result_ = result_ && uniqueListOf(builder_, level_ + 1, "1+1", 1+1, FleetExternalRules::one, FleetExternalRules::two, 10, SOME_parser_);
    result_ = result_ && consumeToken(builder_, "}");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  static boolean param_seq_alt(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, "{");
    result_ = result_ && uniqueListOf(builder_, level_ + 1, FleetExternalRules::param_seq_alt_1_0, FleetExternalRules::param_seq_alt_1_1);
    result_ = result_ && consumeToken(builder_, "}");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  static boolean param_seq_alt_ext(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, "{");
    result_ = result_ && uniqueListOf(builder_, level_ + 1, FleetExternalRules::one, FleetExternalRules::two);
    result_ = result_ && consumeToken(builder_, "}");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  static boolean param_seq_alt_params_ext(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, "{");
    result_ = result_ && uniqueListOf(builder_, level_ + 1, FleetExternalRules::one, "1+1", FleetExternalRules::param_seq_alt_params_ext_1_1, 1+1);
    result_ = result_ && consumeToken(builder_, "}");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  public static boolean public_paren_list(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = comma_paren_list(builder_, level_ + 1, FleetExternalRules::public_paren_list_0_0);
  ...
  static boolean recoverable_item(PsiBuilder builder_, int level_, Parser param) {
    ...
    Marker marker_ = enter_section_(builder_, level_, _NONE_);
    result_ = param.parse(builder_, level_);
    exit_section_(builder_, level_, marker_, result_, false, FleetExternalRules::item_recover);
    return result_;
  }
  ...
  static boolean root(PsiBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, FleetExternalRules::statement);
  }
  ...
  private static final Parser meta_mixed_list_0_0_parser_ = comma_list_$(FleetExternalRules::one);
  ...
  private static final Parser second_class_meta_usage_from_main_0_0_parser_ = FleetExternalRules2.second_class_meta_$(SOME_parser_);
}
// ---- FleetExternalRules2.java -----------------
// This is a generated file. Not intended for manual editing.
package fleet;
...
import static fleet.generated.GeneratedTypes.*;
import static fleet.org.intellij.grammar.test.ParserUtil.*;
import static fleet.FleetExternalRules.*;

@SuppressWarnings({"SimplifiableIfStatement", "UnusedAssignment"})
public class FleetExternalRules2 {
  ...
  static boolean one_list(PsiBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, FleetExternalRules::one);
  }

  /* ********************************************************** */
  // <<listOf (one)>>
  static boolean one_list_par(PsiBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, FleetExternalRules2::one_list_par_0_0);
  }
  ...
  private static final Parser main_class_meta_usage_from_second_0_0_parser_ = main_class_meta_$(FleetExternalRules.SOME_parser_);
  private static final Parser third_class_meta_usage_from_second_0_0_parser_ = FleetExternalRules3.third_class_meta_$(FleetExternalRules.SOME_parser_);
}
// ---- FleetExternalRules3.java -----------------
// This is a generated file. Not intended for manual editing.
package fleet;
...
@SuppressWarnings({"SimplifiableIfStatement", "UnusedAssignment"})
public class FleetExternalRules3 {
  ...
  private static final Parser second_class_meta_usage_from_third_0_0_parser_ = FleetExternalRules2.second_class_meta_$(FleetExternalRules.SOME_parser_);
}