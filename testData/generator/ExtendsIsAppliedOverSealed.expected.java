...
public class GeneratedParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(BAZ, FOO, FOOBS),
  };
  ...
  public static boolean foo(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, FOO, "<foo>");
  ...
  /* ********************************************************** */
  // 'foobs'
  public static boolean foobs(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "foobs")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, FOOBS, "<foobs>");
    result_ = consumeToken(builder_, "foobs");
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
