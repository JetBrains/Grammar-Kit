...
import static fleet.PsiGenUtil.*;
...
public class FleetPsiGen implements PsiParser, LightPsiParser {
  ...
  static boolean id_expr(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "", ID, NUMBER)) return false;
    boolean result_;
    result_ = FleetPsiGen2.specialRef(builder_, level_ + 1);
    if (!result_) result_ = FleetPsiGen2.reference(builder_, level_ + 1);
    if (!result_) result_ = FleetPsiGen2.literal(builder_, level_ + 1);
  ...
  public static boolean include__section__alt(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, result_, false, FleetPsiGen::include_section_recover_);
    return result_;
  }
  ...
  public static boolean root(PsiBuilder builder_, int level_) {
    ...
    result_ = parseGrammar(builder_, level_ + 1, FleetPsiGen::grammar_element);
  ...
  public static boolean root_c(PsiBuilder builder_, int level_) {
    ...
    result_ = FleetPsiGen2.blockOf(builder_, level_ + 1, FleetPsiGen::grammar_element);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  public static boolean root_d(PsiBuilder builder_, int level_) {
    ...
    result_ = listOf(builder_, level_ + 1, FleetPsiGen::grammar_element);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
...
import static fleet.generated.GeneratedTypes.*;
import static fleet.PsiGenUtil.*;
import static fleet.FleetPsiGen.*;
...
public class FleetPsiGenFixes {
  ...
  public static boolean LeftShadow(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, ",");
    result_ = result_ && FleetPsiGen2.identifier(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  public static boolean LeftShadowTest(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = FleetPsiGen2.identifier(builder_, level_ + 1);
  ...
  private static boolean choice_joined_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = FleetPsiGen2.literal(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ID);
    result_ = result_ && consumeToken(builder_, "%");
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean choice_joined_1(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, "%");
    result_ = result_ && consumeToken(builder_, ID);
    result_ = result_ && FleetPsiGen2.literal(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  static boolean fixMetaRule(PsiBuilder builder_, int level_) {
    return FleetPsiGen2.blockOf(builder_, level_ + 1, FleetPsiGen2::identifier);
  }
