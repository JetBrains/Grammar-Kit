...
open class BindersAndHooks(protected val runtime_: SyntaxGeneratedParserRuntimeBase) {
  ...
  companion object {
    ...
    fun both_binders(builder_: SyntaxTreeBuilder, level_: Int): Boolean {
      ...
      var result_: Boolean
      var pinned_: Boolean
      val marker_: Marker = enter_section_(builder_, level_, _NONE_, GeneratedSyntaxElementTypes.BOTH_BINDERS, null)
      ...
      result_ = pinned_ && consumeToken(builder_, GeneratedSyntaxElementTypes.B) && result_
    ...
    fun got_hook(builder_: SyntaxTreeBuilder, level_: Int): Boolean {
      ...
      exit_section_(builder_, marker_, GeneratedSyntaxElementTypes.GOT_HOOK, result_)
      return result_
    }
    ...
    fun left_binder(builder_: SyntaxTreeBuilder, level_: Int): Boolean {
      ...
      exit_section_(builder_, marker_, GeneratedSyntaxElementTypes.LEFT_BINDER, result_)
      return result_
    }
    ...
    fun right_binder(builder_: SyntaxTreeBuilder, level_: Int): Boolean {
      ...
      var result_: Boolean
      val marker_: Marker = enter_section_(builder_, level_, _NONE_, GeneratedSyntaxElementTypes.RIGHT_BINDER, "<right binder>")
