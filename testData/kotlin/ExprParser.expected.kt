...
open class ExpressionParser: PsiParser, LightPsiParser {
  ...
  companion object {
    ...
    /* ********************************************************** */
    // '(' [ !')' expr  (',' expr) * ] ')'
    fun arg_list(builder_: PsiBuilder, level_: Int): Boolean {
      if (!recursion_guard_(builder_, level_, "arg_list")) return false
      var result_: Boolean
      var pinned_: Boolean
      val marker_: Marker = enter_section_(builder_, level_, _NONE_, ARG_LIST, "<arg list>")
    ...
    // [ !')' expr  (',' expr) * ]
    private fun arg_list_1(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // !')' expr  (',' expr) *
    private fun arg_list_1_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // !')'
    private fun arg_list_1_0_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // (',' expr) *
    private fun arg_list_1_0_2(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // ',' expr
    private fun arg_list_1_0_2_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    /* ********************************************************** */
    // expr ';'?
    internal fun element(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // ';'?
    private fun element_1(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    /* ********************************************************** */
    // !('(' | '+' | '-' | '!' | 'multiply' | id | number)
    internal fun element_recover(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // '(' | '+' | '-' | '!' | 'multiply' | id | number
    private fun element_recover_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    fun meta_special_expr(builder_: PsiBuilder, level_: Int): Boolean {
      if (!recursion_guard_(builder_, level_, "meta_special_expr")) return false
      var result_: Boolean
      var pinned_: Boolean
      val marker_: Marker = enter_section_(builder_, level_, _NONE_, SPECIAL_EXPR, "<meta special expr>")
    ...
    // ':' expr
    private fun elvis_expr_1(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // '<' | '>' | '<=' | '>=' | '==' | '!='
    private fun conditional_expr_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    fun unary_plus_expr(PsiBuilder: builder_, level_: Int): Boolean {
    ...
    fun unary_min_expr(PsiBuilder: builder_, level_: Int): Boolean {
    ...
    // AND add_group
    private fun between_expr_1(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    fun unary_not_expr(PsiBuilder: builder_, level_: Int): Boolean {
    ...
    // '.' identifier
    private fun qualification_expr_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // identifier
    fun simple_ref_expr(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // number
    fun literal_expr(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    fun paren_expr(PsiBuilder: builder_, level_: Int): Boolean {
