...
open class ExternalRules: PsiParser, LightPsiParser {
  ...
  companion object {
    ...
    /* ********************************************************** */
    // '(' <<param>> (',' <<param>>) * ')'
    internal fun comma_paren_list(builder_: PsiBuilder, level_: Int, param: Parser): Boolean {
    ...
    // (',' <<param>>) *
    private fun comma_paren_list_2(builder_: PsiBuilder, level_: Int, param: Parser): Boolean {
    ...
    // ',' <<param>>
    private fun comma_paren_list_2_0(builder_: PsiBuilder, level_: Int, param: Parser): Boolean {
    ...
    fun public_paren_list(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // ref | '(' one ')'
    private fun public_paren_list_0_0(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    // '(' one ')'
    private fun public_paren_list_0_0_1(builder_: PsiBuilder, level_: Int): Boolean {
    ...
    /* ********************************************************** */
    fun public_paren_list2(builder_: PsiBuilder, level_: Int): Boolean {
      val marker_: Marker = enter_section_(builder_)
...
open class ExternalRules2 {
  ...
  companion object {
    /* ********************************************************** */
    fun extra_root(builder_: PsiBuilder, level_: Int): Boolean {
      val marker_: Marker = enter_section_(builder_)
