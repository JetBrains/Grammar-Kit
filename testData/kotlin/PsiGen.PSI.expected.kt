...
import sample.MySyntaxTypeFactory
...
object GeneratedSyntaxElementTypes {
  ...
  val CAST_EXPR = sample.MySyntaxTypeFactory.createExprType("CAST_EXPR"))
  ...
  val ITEM_EXPR = sample.MySyntaxTypeFactory.createExprType("ITEM_EXPR"))
  ...
  val MUL_EXPR = sample.MySyntaxTypeFactory.createExprType("MUL_EXPR"))
  val PLUS_EXPR = sample.MySyntaxTypeFactory.createExprType("PLUS_EXPR"))
  val REF_EXPR = sample.MySyntaxTypeFactory.createExprType("REF_EXPR"))
  ...
  val SOME_EXPR = sample.MySyntaxTypeFactory.createExprType("SOME_EXPR"))
...
public class GeneratedSyntaxElementTypeConverterFactory implements ElementTypeConverterFactory {
  ...
  public @NotNull ElementTypeConverter getElementTypeConverter() {
    return ElementTypeConverterKt.elementTypeConverterOf(
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getA_STATEMENT(), GeneratedTypes.A_STATEMENT),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getBLOCK_OF(), GeneratedTypes.BLOCK_OF),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getB_STATEMENT(), GeneratedTypes.B_STATEMENT),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getCAST_EXPR(), GeneratedTypes.CAST_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getCHOICE_JOINED(), GeneratedTypes.CHOICE_JOINED),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getC_STATEMENT(), GeneratedTypes.C_STATEMENT),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getEXPR(), GeneratedTypes.EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getGRAMMAR_ELEMENT(), GeneratedTypes.GRAMMAR_ELEMENT),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getIDENTIFIER(), GeneratedTypes.IDENTIFIER),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getID_EXPR(), GeneratedTypes.ID_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getINCLUDE_SECTION(), GeneratedTypes.INCLUDE_SECTION),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getINCLUDE__SECTION__ALT(), GeneratedTypes.INCLUDE__SECTION__ALT),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getITEM_EXPR(), GeneratedTypes.ITEM_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getLEFT_SHADOW(), GeneratedTypes.LEFT_SHADOW),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getLEFT_SHADOW_TEST(), GeneratedTypes.LEFT_SHADOW_TEST),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getLITERAL(), GeneratedTypes.LITERAL),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getMISSING_EXTERNAL_TYPE(), GeneratedTypes.MISSING_EXTERNAL_TYPE),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getMUL_EXPR(), GeneratedTypes.MUL_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getPLUS_EXPR(), GeneratedTypes.PLUS_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getREF_EXPR(), GeneratedTypes.REF_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getROOT(), GeneratedTypes.ROOT),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getROOT_B(), GeneratedTypes.ROOT_B),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getROOT_C(), GeneratedTypes.ROOT_C),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getROOT_D(), GeneratedTypes.ROOT_D),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getSOME_EXPR(), GeneratedTypes.SOME_EXPR),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getSPECIAL_REF(), GeneratedTypes.SPECIAL_REF),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getSTATEMENT(), GeneratedTypes.STATEMENT),

      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getOP_MUL(), GeneratedTypes.OP_MUL),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getOP_DIV(), GeneratedTypes.OP_DIV),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getSLASH(), GeneratedTypes.SLASH),
      ...
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getNOTSPACE(), GeneratedTypes.NOTSPACE),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getOF(), GeneratedTypes.OF)
    );
  }
}
