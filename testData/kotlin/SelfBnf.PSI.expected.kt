...
public class BnfSyntaxElementTypeConverterFactory implements ElementTypeConverterFactory {
  ...
  public @NotNull ElementTypeConverter getElementTypeConverter() {
    return ElementTypeConverterKt.elementTypeConverterOf(
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_ATTR(), BnfTypes.BNF_ATTR),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_ATTRS(), BnfTypes.BNF_ATTRS),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_ATTR_PATTERN(), BnfTypes.BNF_ATTR_PATTERN),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_CHOICE(), BnfTypes.BNF_CHOICE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_EXPRESSION(), BnfTypes.BNF_EXPRESSION),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_EXTERNAL_EXPRESSION(), BnfTypes.BNF_EXTERNAL_EXPRESSION),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_LIST_ENTRY(), BnfTypes.BNF_LIST_ENTRY),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_LITERAL_EXPRESSION(), BnfTypes.BNF_LITERAL_EXPRESSION),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_MODIFIER(), BnfTypes.BNF_MODIFIER),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_PAREN_EXPRESSION(), BnfTypes.BNF_PAREN_EXPRESSION),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_PAREN_OPT_EXPRESSION(), BnfTypes.BNF_PAREN_OPT_EXPRESSION),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_PREDICATE(), BnfTypes.BNF_PREDICATE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_PREDICATE_SIGN(), BnfTypes.BNF_PREDICATE_SIGN),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_QUANTIFIED(), BnfTypes.BNF_QUANTIFIED),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_QUANTIFIER(), BnfTypes.BNF_QUANTIFIER),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_REFERENCE_OR_TOKEN(), BnfTypes.BNF_REFERENCE_OR_TOKEN),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_RULE(), BnfTypes.BNF_RULE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_SEQUENCE(), BnfTypes.BNF_SEQUENCE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_STRING_LITERAL_EXPRESSION(), BnfTypes.BNF_STRING_LITERAL_EXPRESSION),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_VALUE_LIST(), BnfTypes.BNF_VALUE_LIST),

      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_EQ(), BnfTypes.BNF_OP_EQ),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_IS(), BnfTypes.BNF_OP_IS),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_OR(), BnfTypes.BNF_OP_OR),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_OPT(), BnfTypes.BNF_OP_OPT),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_ONEMORE(), BnfTypes.BNF_OP_ONEMORE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_ZEROMORE(), BnfTypes.BNF_OP_ZEROMORE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_AND(), BnfTypes.BNF_OP_AND),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_OP_NOT(), BnfTypes.BNF_OP_NOT),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_SEMICOLON(), BnfTypes.BNF_SEMICOLON),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_LEFT_BRACE(), BnfTypes.BNF_LEFT_BRACE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_RIGHT_BRACE(), BnfTypes.BNF_RIGHT_BRACE),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_LEFT_BRACKET(), BnfTypes.BNF_LEFT_BRACKET),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_RIGHT_BRACKET(), BnfTypes.BNF_RIGHT_BRACKET),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_LEFT_PAREN(), BnfTypes.BNF_LEFT_PAREN),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_RIGHT_PAREN(), BnfTypes.BNF_RIGHT_PAREN),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_EXTERNAL_START(), BnfTypes.BNF_EXTERNAL_START),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_EXTERNAL_END(), BnfTypes.BNF_EXTERNAL_END),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_ID(), BnfTypes.BNF_ID),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_STRING(), BnfTypes.BNF_STRING),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_NUMBER(), BnfTypes.BNF_NUMBER),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_LINE_COMMENT(), BnfTypes.BNF_LINE_COMMENT),
      new Pair<SyntaxElementType, IElementType>(BnfSyntaxTypes.INSTANCE.getBNF_BLOCK_COMMENT(), BnfTypes.BNF_BLOCK_COMMENT)
    );
  }
}
