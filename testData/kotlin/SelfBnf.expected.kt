...
open class GrammarParser(protected val runtime: SyntaxGeneratedParserRuntimeBase) {
  ...
  companion object {
    ...
    internal fun alt_choice_element(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // !attr_start_simple
    private fun alt_choice_element_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    fun attr(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    /* ********************************************************** */
    // !('}' | attr_start)
    internal fun attr_recover(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // attr_pattern '=' | '='
    private fun attr_start_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // attr_pattern '='
    private fun attr_start_1_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // attr_pattern?
    private fun attr_start_simple_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    /* ********************************************************** */
    // attr_value_inner !'='
    internal fun attr_value(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // !'='
    private fun attr_value_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    //   | literal_expression
    //   | value_list
    internal fun attr_value_inner(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // attr *
    private fun attrs_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // '|' sequence
    private fun choice_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // choice?
    private fun expression_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // option *
    private fun external_expression_2(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    /* ********************************************************** */
    // !<<eof>> (attrs | rule)
    internal fun grammar_element(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // !<<eof>>
    private fun grammar_element_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // attrs | rule
    private fun grammar_element_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    /* ********************************************************** */
    // !('{'|rule_start)
    internal fun grammar_element_recover(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // id list_entry_tail? | string_literal_expression
    private fun list_entry_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // id list_entry_tail?
    private fun list_entry_0_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // list_entry_tail?
    private fun list_entry_0_0_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    /* ********************************************************** */
    // !(']' | '}' | id | string)
    internal fun list_entry_recover(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    internal fun option(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // simple quantified?
    private fun option_2(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // quantified?
    private fun option_2_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // '(' expression ')'
    private fun paren_expression_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // '{' alt_choice_element '}'
    private fun paren_expression_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // attrs?
    private fun rule_2(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    /* ********************************************************** */
    // modifier* id '::='
    internal fun rule_start(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // modifier*
    private fun rule_start_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    internal fun sequence_recover(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // !(';'|'|'|'('|')'|'['|']'|'{'|'}')
    private fun sequence_recover_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    //   | external_expression
    //   | paren_expression
    internal fun simple(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // !(modifier* id '::=' ) reference_or_token
    private fun simple_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // !(modifier* id '::=' )
    private fun simple_0_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // modifier* id '::='
    private fun simple_0_0_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // modifier*
    private fun simple_0_0_0_0(builder: SyntaxTreeBuilder, level: Int): Boolean {
    ...
    // list_entry *
    private fun value_list_1(builder: SyntaxTreeBuilder, level: Int): Boolean {
