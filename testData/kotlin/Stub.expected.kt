...
object FooParser {
  ...
  fun element2(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._NONE_, FooSyntaxTypes.ELEMENT_2, "<element 2>")
  ...
  fun element3(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._NONE_, FooSyntaxTypes.ELEMENT_3, "<element 3>")
    result_ = runtime_.consumeToken("bb")
  ...
  fun element4(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._NONE_, FooSyntaxTypes.ELEMENT_4, "<element 4>")
    result_ = runtime_.consumeToken("bb")
  ...
  fun element5(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._NONE_, FooSyntaxTypes.ELEMENT_5, "<element 5>")
  ...
  fun interface_type(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._NONE_, FooSyntaxTypes.INTERFACE_TYPE, "<interface type>")
  ...
  fun struct_type(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._NONE_, FooSyntaxTypes.STRUCT_TYPE, "<struct type>")
  ...
  fun type(runtime_: SyntaxGeneratedParserRuntime, level_: Int): Boolean {
    ...
    var result_: Boolean
    val marker_: Marker = runtime_.enter_section_(level_, Modifiers._COLLAPSE_, FooSyntaxTypes.TYPE, "<type>")
