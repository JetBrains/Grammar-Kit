...
public class GeneratedSyntaxElementTypeConverterFactory implements ElementTypeConverterFactory {
  ...
  public @NotNull ElementTypeConverter getElementTypeConverter() {
    return ElementTypeConverterKt.elementTypeConverterOf(
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getELEMENT_1(), FooTypes.ELEMENT_1),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getELEMENT_2(), FooTypes.ELEMENT_2),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getELEMENT_3(), FooTypes.ELEMENT_3),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getELEMENT_4(), FooTypes.ELEMENT_4),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getELEMENT_5(), FooTypes.ELEMENT_5),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getINTERFACE_TYPE(), FooTypes.INTERFACE_TYPE),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getSTRUCT_TYPE(), FooTypes.STRUCT_TYPE),
      new Pair<SyntaxElementType, IElementType>(GeneratedSyntaxElementTypes.INSTANCE.getTYPE(), FooTypes.TYPE)
    );
  }
}
...
import org.intellij.grammar.test.StubTest.GenericBaseMissing;
import test.stub.Element1Stub;
import test.psi.*;
import com.intellij.psi.tree.IElementType;
