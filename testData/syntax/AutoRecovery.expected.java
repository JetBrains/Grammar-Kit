...
public class GeneratedParser implements PsiParser, LightPsiParser {
  ...
  // (';' list ) *
  private static boolean file_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ';' list
  private static boolean file_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // number
  public static boolean item(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // "(" [!")" item (',' item) * ] ")"
  public static boolean list(SyntaxTreeBuilder builder_, int level_) {
  ...
  // [!")" item (',' item) * ]
  private static boolean list_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // !")" item (',' item) *
  private static boolean list_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // !")"
  private static boolean list_1_0_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (',' item) *
  private static boolean list_1_0_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ',' item
  private static boolean list_1_0_2_0(SyntaxTreeBuilder builder_, int level_) {
