...
public class Autopin implements PsiParser, LightPsiParser {
  ...
  public static boolean create_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean create_table_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  // TEMP?
  private static boolean create_table_statement_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // GLOBAL|LOCAL
  private static boolean create_table_statement_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean drop_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean drop_table_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // a b (c d e)
  public static boolean override_nested_sequence(SyntaxTreeBuilder builder_, int level_) {
  ...
  // c d e
  private static boolean override_nested_sequence_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // [] (a|b)
  static boolean pinned_on_start(SyntaxTreeBuilder builder_, int level_) {
  ...
  // []
  private static boolean pinned_on_start_0(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  // a|b
  private static boolean pinned_on_start_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // a b c d table_ref
  static boolean token_sequence1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // a b table_ref c d e
  static boolean token_sequence2(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean token_sequence3(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // [] a
  static boolean token_sequence4(SyntaxTreeBuilder builder_, int level_) {
  ...
  // []
  private static boolean token_sequence4_0(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  /* ********************************************************** */
  // (a|&b) pinned_on_start
  static boolean token_sequence5(SyntaxTreeBuilder builder_, int level_) {
  ...
  // a|&b
  private static boolean token_sequence5_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // &b
  private static boolean token_sequence5_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '+' a "+" a '+++'
  static boolean token_sequence6(SyntaxTreeBuilder builder_, int level_) {
