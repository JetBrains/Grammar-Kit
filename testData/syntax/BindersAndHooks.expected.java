...
public class BindersAndHooks implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // A item B
  public static boolean both_binders(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A
  public static boolean got_hook(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  static boolean item(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  /* ********************************************************** */
  // A B
  public static boolean left_binder(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // item
  public static boolean right_binder(SyntaxTreeBuilder builder_, int level_) {
