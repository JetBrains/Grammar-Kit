...
public class ExternalRules implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // <<uniqueListOf one>>
  public static boolean collapse_one(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  public static boolean collapse_two(SyntaxTreeBuilder builder_, int level_) {
  ...
  // <<param>> (',' <<param>>) *
  public static boolean comma_list(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // (',' <<param>>) *
  private static boolean comma_list_1(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // ',' <<param>>
  private static boolean comma_list_1_0(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  public static boolean comma_list_pinned(SyntaxTreeBuilder builder_, int level_, Parser head, Parser param) {
  ...
  private static boolean comma_list_pinned_2(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // <<comma_list_tail <<param>>>>
  private static boolean comma_list_pinned_2_0(SyntaxTreeBuilder builder_, int level_, Parser param) {
    return comma_list_tail(builder_, level_ + 1, param);
  }

  /* ********************************************************** */
  // ',' <<param>>
  public static boolean comma_list_tail(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  /* ********************************************************** */
  // '(' <<param>> (',' <<param>>) * ')'
  static boolean comma_paren_list(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // (',' <<param>>) *
  private static boolean comma_paren_list_2(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // ',' <<param>>
  private static boolean comma_paren_list_2_0(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  /* ********************************************************** */
  // empty_external
  static boolean empty_external_usage(SyntaxTreeBuilder builder_, int level_) {
    return null(builder_, level_ + 1);
  }

  /* ********************************************************** */
  // <<>>
  static boolean empty_external_usage2(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  /* ********************************************************** */
  // !(',' | ';' | ')')
  static boolean item_recover(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ',' | ';' | ')'
  private static boolean item_recover_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean list_of_lists(SyntaxTreeBuilder builder_, int level_, Parser head, Parser param) {
  ...
  private static boolean list_of_lists_2(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // <<comma_list_tail <<comma_list <<param>>>>>>
  private static boolean list_of_lists_2_0(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // <<p>>
  static boolean main_class_meta(SyntaxTreeBuilder builder_, int level_, Parser p) {
    return p.parse(builder_, level_);
  }

  /* ********************************************************** */
  // <<listOf "1+2" '1+2' <<param>>>>
  static boolean meta_mixed(SyntaxTreeBuilder builder_, int level_, Parser param) {
    return listOf(builder_, level_ + 1, "1+2", 1+2, param);
  }

  /* ********************************************************** */
  // <<meta_mixed <<comma_list one>>>>
  static boolean meta_mixed_list(SyntaxTreeBuilder builder_, int level_) {
    return meta_mixed(builder_, level_ + 1, meta_mixed_list_0_0_parser_);
  }

  /* ********************************************************** */
  // <<meta_mixed (<<comma_list one>>)>>
  static boolean meta_mixed_list_paren(SyntaxTreeBuilder builder_, int level_) {
    return meta_mixed(builder_, level_ + 1, ExternalRules::meta_mixed_list_paren_0_0);
  }

  // <<comma_list one>>
  private static boolean meta_mixed_list_paren_0_0(SyntaxTreeBuilder builder_, int level_) {
    return comma_list(builder_, level_ + 1, ExternalRules::one);
  }

  /* ********************************************************** */
  // <<meta_mixed statement>>
  static boolean meta_mixed_simple(SyntaxTreeBuilder builder_, int level_) {
    return meta_mixed(builder_, level_ + 1, ExternalRules::statement);
  }

  /* ********************************************************** */
  // <<comma_list <<comma_list <<comma_list <<comma_list <<comma_list <<param>>>>>>>>>>>>
  public static boolean meta_multi_level(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  static boolean meta_multi_level_no_closure(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean meta_multi_level_pinned(SyntaxTreeBuilder builder_, int level_, Parser head, Parser param) {
  ...
  /* ********************************************************** */
  // <<comma_list <<comma_list_pinned <<head>> (<<comma_list <<comma_list <<comma_list <<param>>>>>>>>)>>>>
  public static boolean meta_multi_level_pinned_paren(SyntaxTreeBuilder builder_, int level_, Parser head, Parser param) {
  ...
  private static boolean meta_multi_level_pinned_paren_0_0_1(SyntaxTreeBuilder builder_, int level_, Parser param) {
    return comma_list(builder_, level_ + 1, comma_list_$(comma_list_$(param)));
  }

  /* ********************************************************** */
  // <<comma_list_pinned one (one | two)>>
  static boolean meta_seq(SyntaxTreeBuilder builder_, int level_) {
    return comma_list_pinned(builder_, level_ + 1, ExternalRules::one, ExternalRules::meta_seq_0_1);
  }

  // one | two
  private static boolean meta_seq_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean meta_seq_of_lists(SyntaxTreeBuilder builder_, int level_) {
    return list_of_lists(builder_, level_ + 1, ExternalRules::one, ExternalRules::meta_seq_of_lists_0_1);
  }

  // one | two
  private static boolean meta_seq_of_lists_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // (<<list_of_lists one (one | two)>>)?
  static boolean meta_seq_of_lists_opt(SyntaxTreeBuilder builder_, int level_) {
  ...
  // <<list_of_lists one (one | two)>>
  private static boolean meta_seq_of_lists_opt_0(SyntaxTreeBuilder builder_, int level_) {
    return list_of_lists(builder_, level_ + 1, ExternalRules::one, ExternalRules::meta_seq_of_lists_opt_0_0_1);
  }

  // one | two
  private static boolean meta_seq_of_lists_opt_0_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // <<comma_list one>>
  static boolean meta_simple(SyntaxTreeBuilder builder_, int level_) {
    return comma_list(builder_, level_ + 1, ExternalRules::one);
  }

  /* ********************************************************** */
  // <<comma_list (<<param>> | some)>>
  public static boolean meta_with_in_place(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  // <<param>> | some
  private static boolean meta_with_in_place_0_0(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  static boolean multi_level(SyntaxTreeBuilder builder_, int level_) {
    return meta_multi_level(builder_, level_ + 1, ExternalRules::one);
  }

  /* ********************************************************** */
  // <<two_params_meta <<nested1>> <<two_params_meta <<nested2>> <<nested3>>>>>>
  static boolean nested_meta(SyntaxTreeBuilder builder_, int level_, Parser nested1, Parser nested2, Parser nested3) {
  ...
  static boolean nested_mixed(SyntaxTreeBuilder builder_, int level_, Parser c) {
  ...
  // <<two_params_meta '%' <<c>>>>
  private static boolean nested_mixed_0_0(SyntaxTreeBuilder builder_, int level_, Parser c) {
    return two_params_meta(builder_, level_ + 1, perc_parser_, c);
  }

  /* ********************************************************** */
  // 'one'
  public static boolean one(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean param_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  // one | two | 10 | some
  private static boolean param_choice_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '{' <<uniqueListOf {one | two | 10 | some}>> '}'
  static boolean param_choice_alt(SyntaxTreeBuilder builder_, int level_) {
  ...
  // one | two | 10 | some
  private static boolean param_choice_alt_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '{' <<uniqueListOf [one | two | 10 | some]>> '}'
  static boolean param_opt(SyntaxTreeBuilder builder_, int level_) {
  ...
  // [one | two | 10 | some]
  private static boolean param_opt_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // one | two | 10 | some
  private static boolean param_opt_1_0_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean param_seq(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '{' <<uniqueListOf {one | two} [10 | some]>> '}'
  static boolean param_seq_alt(SyntaxTreeBuilder builder_, int level_) {
  ...
  // one | two
  private static boolean param_seq_alt_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // [10 | some]
  private static boolean param_seq_alt_1_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // 10 | some
  private static boolean param_seq_alt_1_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean param_seq_alt_ext(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean param_seq_alt_params_ext(SyntaxTreeBuilder builder_, int level_) {
  ...
  // !two
  private static boolean param_seq_alt_params_ext_1_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // <<listOf '%'>>
  static boolean perc_list(SyntaxTreeBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, perc_parser_);
  }

  /* ********************************************************** */
  // <<listOf perc_re>>
  static boolean perc_re_list1(SyntaxTreeBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, PERC_RE_parser_);
  }

  /* ********************************************************** */
  // <<listOf (perc_re)>>
  static boolean perc_re_list2(SyntaxTreeBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, perc_re_list2_0_0_parser_);
  }

  /* ********************************************************** */
  // <<comma_paren_list (ref | '(' one ')')>>
  public static boolean public_paren_list(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ref | '(' one ')'
  private static boolean public_paren_list_0_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // '(' one ')'
  private static boolean public_paren_list_0_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  public static boolean public_paren_list2(SyntaxTreeBuilder builder_, int level_) {
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // <<param>>
  static boolean recoverable_item(SyntaxTreeBuilder builder_, int level_, Parser param) {
  ...
  /* ********************************************************** */
  // <<param>>
  static boolean recoverable_item2(SyntaxTreeBuilder builder_, int level_, Parser param, Parser recover_arg) {
  ...
  /* ********************************************************** */
  // <<recover_arg>> <<param>>
  static boolean recoverable_item3(SyntaxTreeBuilder builder_, int level_, Parser recover_arg, Parser param) {
  ...
  static boolean second_class_meta_usage_from_main(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // 'two'
  public static boolean two(SyntaxTreeBuilder builder_, int level_) {
  ...
  // <<a>> <<b>>
  public static boolean two_params_meta(SyntaxTreeBuilder builder_, int level_, Parser a, Parser b) {
...
public class ExternalRules2 {
  ...
  /* ********************************************************** */
  public static boolean extra_root(SyntaxTreeBuilder builder_, int level_) {
    Marker marker_ = enter_section_(builder_);
  ...
  static boolean main_class_meta_usage_from_second(SyntaxTreeBuilder builder_, int level_) {
    return comma_list(builder_, level_ + 1, main_class_meta_usage_from_second_0_0_parser_);
  }

  /* ********************************************************** */
  // <<listOf one>>
  static boolean one_list(SyntaxTreeBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, ExternalRules::one);
  }

  /* ********************************************************** */
  // <<listOf (one)>>
  static boolean one_list_par(SyntaxTreeBuilder builder_, int level_) {
    return listOf(builder_, level_ + 1, ExternalRules2::one_list_par_0_0);
  }

  // (one)
  private static boolean one_list_par_0_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // <<bmp>>
  static boolean second_class_meta(SyntaxTreeBuilder builder_, int level_, Parser bmp) {
    return bmp.parse(builder_, level_);
  }

  /* ********************************************************** */
  // <<comma_list <<third_class_meta some>>>>
  static boolean third_class_meta_usage_from_second(SyntaxTreeBuilder builder_, int level_) {
...
public class ExternalRules3 {
  ...
  /* ********************************************************** */
  // <<comma_list <<second_class_meta some>>>>
  static boolean second_class_meta_usage_from_third(SyntaxTreeBuilder builder_, int level_) {
  ...
  // <<fmp>>
  static boolean third_class_meta(SyntaxTreeBuilder builder_, int level_, Parser fmp) {
