...
public class Fixes implements PsiParser, LightPsiParser {
  ...
  // &<Foo  predicate>
  private static boolean Foo_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  static boolean Foo__predicate(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  /* ********************************************************** */
  static boolean Foo__recovery(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  /* ********************************************************** */
  public static boolean Foo__ﾉ__ω__ﾉ_ﾐ_____inner(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // orRestriction
  public static boolean a_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean andRestriction(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ( "&&" singleRestriction ) *
  private static boolean andRestriction_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // "&&" singleRestriction
  private static boolean andRestriction_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // andRestriction
  public static boolean b_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // expr A erl_tail
  public static boolean erl_list(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean erl_tail(SyntaxTreeBuilder builder_, int level_) {
  ...
  // A zome
  private static boolean erl_tail_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // '&&' expr some erl_tail
  private static boolean erl_tail_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // (A erl_tail_bad)*
  static boolean erl_tail_bad(SyntaxTreeBuilder builder_, int level_) {
  ...
  // A erl_tail_bad
  private static boolean erl_tail_bad_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // a_expr | b_expr
  public static boolean expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A (some A | A some A)
  public static boolean import_$(SyntaxTreeBuilder builder_, int level_) {
  ...
  // some A | A some A
  private static boolean import_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // some A
  private static boolean import_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // A some A
  private static boolean import_1_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // expr
  public static boolean left_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  // <<p>> <<q>>
  static boolean meta2(SyntaxTreeBuilder builder_, int level_, Parser p, Parser q) {
  ...
  static boolean nested_meta_pin(SyntaxTreeBuilder builder_, int level_) {
  ...
  private static boolean nested_meta_pin_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ("2")
  private static boolean nested_meta_pin_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // "3" "a"
  private static boolean nested_meta_pin_1_1_0_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // !"b"
  private static boolean nested_meta_pin_1_1_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // "4" "a"
  private static boolean nested_meta_pin_1_1_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // "5" "a"
  private static boolean nested_meta_pin_1_1_1_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean not_optimized_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | private_named | private_unnamed
  static boolean optimized_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // token-two | '#'
  static boolean optimized_choice2(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // "foo" | "bar"
  static boolean optimized_choice3(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean orRestriction(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ( "||" andRestriction ) *
  private static boolean orRestriction_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // "||" andRestriction
  private static boolean orRestriction_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | &B A
  static boolean pinned_report(SyntaxTreeBuilder builder_, int level_) {
  ...
  // &B A
  private static boolean pinned_report_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // &B
  private static boolean pinned_report_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | &<<aux>> A
  static boolean pinned_report_ext(SyntaxTreeBuilder builder_, int level_) {
  ...
  // &<<aux>> A
  private static boolean pinned_report_ext_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // &<<aux>>
  private static boolean pinned_report_ext_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // "foo"
  static boolean private_named(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // "foo"
  static boolean private_unnamed(SyntaxTreeBuilder builder_, int level_) {
    return consumeToken(builder_, "foo");
  }

  /* ********************************************************** */
  // some [recursive]
  static boolean recursive(SyntaxTreeBuilder builder_, int level_) {
  ...
  // [recursive]
  private static boolean recursive_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  public static boolean recursive_extendA(SyntaxTreeBuilder builder_, int level_) {
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  public static boolean recursive_extendB(SyntaxTreeBuilder builder_, int level_) {
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // <<p>> (',' <<p>>)*
  static boolean sequence(SyntaxTreeBuilder builder_, int level_, Parser p) {
  ...
  // (',' <<p>>)*
  private static boolean sequence_1(SyntaxTreeBuilder builder_, int level_, Parser p) {
  ...
  // ',' <<p>>
  private static boolean sequence_1_0(SyntaxTreeBuilder builder_, int level_, Parser p) {
  ...
  static boolean singleRestriction(SyntaxTreeBuilder builder_, int level_) {
  ...
  // A expr
  private static boolean singleRestriction_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // '(' orRestriction ')'
  private static boolean singleRestriction_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A
  public static boolean some(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // expr left_expr *
  public static boolean some_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  // left_expr *
  private static boolean some_expr_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // <<sequence some>>
  public static boolean some_seq(SyntaxTreeBuilder builder_, int level_) {
  ...
  static boolean two_usages(SyntaxTreeBuilder builder_, int level_) {
  ...
  private static boolean two_usages_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // expr two_usages_left
  private static boolean two_usages_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  public static boolean two_usages_left(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // recursive
  public static boolean with_recursive(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // token-one | token-two
  public static boolean zome(SyntaxTreeBuilder builder_, int level_) {
