...
public class PsiGen implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // b_expr plus_expr *
  static boolean a_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  // plus_expr *
  private static boolean a_expr_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id_expr mul_expr *
  static boolean b_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  // mul_expr *
  private static boolean b_expr_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (',' a_expr) *
  private static boolean expr_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ',' a_expr
  private static boolean expr_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id
  public static boolean external_same_as_type2(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // number
  public static boolean external_type(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id
  public static boolean external_type2(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id
  public static boolean external_type3(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // expr | external_type3
  public static boolean grammar_element(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // root
  static boolean grammar_root(SyntaxTreeBuilder builder_, int level_) {
    return root(builder_, level_ + 1);
  }

  /* ********************************************************** */
  // specialRef | reference | literal | external_type | external_type2
  static boolean id_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id number
  public static boolean include__section__alt(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean include_section(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // !()
  static boolean include_section_recover_(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ()
  private static boolean include_section_recover__0(SyntaxTreeBuilder builder_, int level_) {
    return true;
  }

  /* ********************************************************** */
  // <<p>> +
  static boolean listOf(SyntaxTreeBuilder builder_, int level_, Parser p) {
  ...
  /* ********************************************************** */
  // '*' expr
  public static boolean mul_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '+' expr
  public static boolean plus_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean root(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean root_b(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean root_c(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean root_d(SyntaxTreeBuilder builder_, int level_) {
...
public class PsiGen2 {
  ...
  /* ********************************************************** */
  // <<p>> +
  public static boolean blockOf(SyntaxTreeBuilder builder_, int level_, Parser p) {
  ...
  /* ********************************************************** */
  // '::' id
  public static boolean cast_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id
  public static boolean identifier(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '[' number ']'
  public static boolean item_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // number
  public static boolean literal(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '.' identifier
  public static boolean qref_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // identifier
  public static boolean ref_expr(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // ref_expr qref_expr *
  static boolean reference(SyntaxTreeBuilder builder_, int level_) {
  ...
  // qref_expr *
  private static boolean reference_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  private static boolean some_expr_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // specialRef b_expr
  private static boolean some_expr_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (item_expr) *
  private static boolean some_expr_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (item_expr)
  private static boolean some_expr_2_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // specialRef b_expr
  static boolean some_expr_private(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean specialRef(SyntaxTreeBuilder builder_, int level_) {
...
public class PsiGenFixes {
  ...
  /* ********************************************************** */
  // ',' identifier
  public static boolean LeftShadow(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean LeftShadowTest(SyntaxTreeBuilder builder_, int level_) {
  ...
  // LeftShadow *
  private static boolean LeftShadowTest_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id | number
  public static boolean a_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id | number
  public static boolean b_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // id | number
  public static boolean c_statement(SyntaxTreeBuilder builder_, int level_) {
  ...
  public static boolean choice_joined(SyntaxTreeBuilder builder_, int level_) {
  ...
  // literal id '%'
  private static boolean choice_joined_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // '%' id literal
  private static boolean choice_joined_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // <<blockOf identifier>>
  static boolean fixMetaRule(SyntaxTreeBuilder builder_, int level_) {
    return PsiGen2.blockOf(builder_, level_ + 1, PsiGen2::identifier);
  }

  /* ********************************************************** */
  // identifier
  public static boolean publicMethodToCall(SyntaxTreeBuilder builder_, int level_) {
  ...
  private static boolean statement_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // &<<external>>
  private static boolean statement_0_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  private static boolean statement_0_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  private static boolean statement_1(SyntaxTreeBuilder builder_, int level_) {
  ...
  // !<<external>>
  private static boolean statement_1_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (c_statement)
  private static boolean statement_1_1(SyntaxTreeBuilder builder_, int level_) {
