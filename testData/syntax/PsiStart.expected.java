...
public class GeneratedParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // 'id'
  public static boolean element(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // 'name' '->' element
  public static boolean entry(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // list | map
  static boolean grammar(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (',' element) *
  private static boolean list_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ',' element
  private static boolean list_2_0(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '(' entry (',' entry) * ')'
  public static boolean map(SyntaxTreeBuilder builder_, int level_) {
  ...
  // (',' entry) *
  private static boolean map_2(SyntaxTreeBuilder builder_, int level_) {
  ...
  // ',' entry
  private static boolean map_2_0(SyntaxTreeBuilder builder_, int level_) {
