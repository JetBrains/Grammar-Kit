...
public class GrammarParser implements PsiParser, LightPsiParser {
  ...
  static boolean alt_choice_element(SyntaxTreeBuilder builder, int level) {
  ...
  // !attr_start_simple
  private static boolean alt_choice_element_0(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean attr(SyntaxTreeBuilder builder, int level) {
  ...
  // ';'?
  private static boolean attr_2(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean attr_pattern(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // !('}' | attr_start)
  static boolean attr_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // '}' | attr_start
  private static boolean attr_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id (attr_pattern '=' | '=')
  static boolean attr_start(SyntaxTreeBuilder builder, int level) {
  ...
  // attr_pattern '=' | '='
  private static boolean attr_start_1(SyntaxTreeBuilder builder, int level) {
  ...
  // attr_pattern '='
  private static boolean attr_start_1_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id attr_pattern? '='
  static boolean attr_start_simple(SyntaxTreeBuilder builder, int level) {
  ...
  // attr_pattern?
  private static boolean attr_start_simple_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // attr_value_inner !'='
  static boolean attr_value(SyntaxTreeBuilder builder, int level) {
  ...
  // !'='
  private static boolean attr_value_1(SyntaxTreeBuilder builder, int level) {
  ...
  //   | literal_expression
  //   | value_list
  static boolean attr_value_inner(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '{' attr * '}'
  public static boolean attrs(SyntaxTreeBuilder builder, int level) {
  ...
  // attr *
  private static boolean attrs_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // ( '|' sequence ) +
  public static boolean choice(SyntaxTreeBuilder builder, int level) {
  ...
  // '|' sequence
  private static boolean choice_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // sequence choice?
  public static boolean expression(SyntaxTreeBuilder builder, int level) {
  ...
  // choice?
  private static boolean expression_1(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean external_expression(SyntaxTreeBuilder builder, int level) {
  ...
  // option *
  private static boolean external_expression_2(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // !<<eof>> (attrs | rule)
  static boolean grammar_element(SyntaxTreeBuilder builder, int level) {
  ...
  // !<<eof>>
  private static boolean grammar_element_0(SyntaxTreeBuilder builder, int level) {
  ...
  // attrs | rule
  private static boolean grammar_element_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // !('{'|rule_start)
  static boolean grammar_element_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // '{'|rule_start
  private static boolean grammar_element_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean list_entry(SyntaxTreeBuilder builder, int level) {
  ...
  // id list_entry_tail? | string_literal_expression
  private static boolean list_entry_0(SyntaxTreeBuilder builder, int level) {
  ...
  // id list_entry_tail?
  private static boolean list_entry_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // list_entry_tail?
  private static boolean list_entry_0_0_1(SyntaxTreeBuilder builder, int level) {
  ...
  // ';'?
  private static boolean list_entry_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // !(']' | '}' | id | string)
  static boolean list_entry_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // ']' | '}' | id | string
  private static boolean list_entry_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '=' string_literal_expression
  static boolean list_entry_tail(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean modifier(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean option(SyntaxTreeBuilder builder, int level) {
  ...
  // simple quantified?
  private static boolean option_2(SyntaxTreeBuilder builder, int level) {
  ...
  // quantified?
  private static boolean option_2_1(SyntaxTreeBuilder builder, int level) {
  ...
  // '(' expression ')'
  private static boolean paren_expression_0(SyntaxTreeBuilder builder, int level) {
  ...
  // '{' alt_choice_element '}'
  private static boolean paren_expression_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '[' expression ']'
  public static boolean paren_opt_expression(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean predicate(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '&' | '!'
  public static boolean predicate_sign(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // quantifier
  public static boolean quantified(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '?' | '+' | '*'
  public static boolean quantifier(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id
  public static boolean reference_or_token(SyntaxTreeBuilder builder, int level) {
  ...
  // attrs?
  private static boolean rule_2(SyntaxTreeBuilder builder, int level) {
  ...
  // ';'?
  private static boolean rule_3(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // modifier* id '::='
  static boolean rule_start(SyntaxTreeBuilder builder, int level) {
  ...
  // modifier*
  private static boolean rule_start_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // option *
  public static boolean sequence(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean sequence_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // !(';'|'|'|'('|')'|'['|']'|'{'|'}')
  private static boolean sequence_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  // ';'|'|'|'('|')'|'['|']'|'{'|'}'
  private static boolean sequence_recover_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  //   | external_expression
  //   | paren_expression
  static boolean simple(SyntaxTreeBuilder builder, int level) {
  ...
  // !(modifier* id '::=' ) reference_or_token
  private static boolean simple_0(SyntaxTreeBuilder builder, int level) {
  ...
  // !(modifier* id '::=' )
  private static boolean simple_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // modifier* id '::='
  private static boolean simple_0_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // modifier*
  private static boolean simple_0_0_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // string
  public static boolean string_literal_expression(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '[' list_entry * ']'
  public static boolean value_list(SyntaxTreeBuilder builder, int level) {
  ...
  // list_entry *
  private static boolean value_list_1(SyntaxTreeBuilder builder, int level) {
