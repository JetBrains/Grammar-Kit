...
public class JFlexParser implements PsiParser, LightPsiParser {
  ...
  public ASTNode parse(SyntaxElementType type, SyntaxTreeBuilder builder) {
    parseLight(type, builder);
    return builder.getTreeBuilt();
  }

  public void parseLight(SyntaxElementType type, SyntaxTreeBuilder builder) {
    boolean result;
  ...
  protected boolean parse_root_(SyntaxElementType type, SyntaxTreeBuilder builder) {
    return parse_root_(type, builder, 0);
  }

  static boolean parse_root_(SyntaxElementType type, SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '{' raw? '}' | '|'
  public static boolean action(SyntaxTreeBuilder builder, int level) {
  ...
  // '{' raw? '}'
  private static boolean action_0(SyntaxTreeBuilder builder, int level) {
  ...
  // raw?
  private static boolean action_0_1(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean char_class_atom(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean char_class_item(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '&&' | '||' | '~~' | '--'
  static boolean char_class_op(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // char | char_esc
  static boolean char_or_esc(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean char_range(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean declaration(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean declaration_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // !(<<is_percent>> | id '=')
  private static boolean declaration_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  // <<is_percent>> | id '='
  private static boolean declaration_recover_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean declarations_section(SyntaxTreeBuilder builder, int level) {
  ...
  // []
  private static boolean declarations_section_0(SyntaxTreeBuilder builder, int level) {
    return true;
  }

  // (!(<<eof>> | '%%') declaration) *
  private static boolean declarations_section_2(SyntaxTreeBuilder builder, int level) {
  ...
  // !(<<eof>> | '%%') declaration
  private static boolean declarations_section_2_0(SyntaxTreeBuilder builder, int level) {
  ...
  // !(<<eof>> | '%%')
  private static boolean declarations_section_2_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // <<eof>> | '%%'
  private static boolean declarations_section_2_0_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean flex_file(SyntaxTreeBuilder builder, int level) {
  ...
  // []
  private static boolean flex_file_0(SyntaxTreeBuilder builder, int level) {
    return true;
  }

  /* ********************************************************** */
  // raw?
  public static boolean java_code(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id ( '.' id ) *
  public static boolean java_name(SyntaxTreeBuilder builder, int level) {
  ...
  // ( '.' id ) *
  private static boolean java_name_1(SyntaxTreeBuilder builder, int level) {
  ...
  // '.' id
  private static boolean java_name_1_0(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean java_type(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean java_type_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // [java_type (',' java_type) *]
  static boolean java_type_list(SyntaxTreeBuilder builder, int level) {
  ...
  // java_type (',' java_type) *
  private static boolean java_type_list_0(SyntaxTreeBuilder builder, int level) {
  ...
  // (',' java_type) *
  private static boolean java_type_list_0_1(SyntaxTreeBuilder builder, int level) {
  ...
  // ',' java_type
  private static boolean java_type_list_0_1_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '<' !'>' java_type (',' java_type) * '>'
  public static boolean java_type_parameters(SyntaxTreeBuilder builder, int level) {
  ...
  // !'>'
  private static boolean java_type_parameters_1(SyntaxTreeBuilder builder, int level) {
  ...
  // (',' java_type) *
  private static boolean java_type_parameters_3(SyntaxTreeBuilder builder, int level) {
  ...
  // ',' java_type
  private static boolean java_type_parameters_3_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // [] rule_group_item +
  public static boolean lexical_rules_section(SyntaxTreeBuilder builder, int level) {
  ...
  // []
  private static boolean lexical_rules_section_0(SyntaxTreeBuilder builder, int level) {
    return true;
  }

  // rule_group_item +
  private static boolean lexical_rules_section_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // new_line <<p>> new_line
  static boolean line(SyntaxTreeBuilder builder, int level, Parser aP) {
  ...
  /* ********************************************************** */
  // '$' | '/' expression
  public static boolean look_ahead(SyntaxTreeBuilder builder, int level) {
  ...
  // '/' expression
  private static boolean look_ahead_1(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean macro_definition(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean macro_definition_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // new_line id '=' | '%%' | <<is_percent>>
  private static boolean macro_definition_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  // new_line id '='
  private static boolean macro_definition_recover_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id
  public static boolean macro_reference(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // &<<is_new_line>>
  static boolean new_line(SyntaxTreeBuilder builder, int level) {
  ...
  //   | option_count_column
  //   | option_obsolete
  public static boolean option(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%16bit'
  public static boolean option_16bit(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%7bit'
  public static boolean option_7bit(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%abstract'
  public static boolean option_abstract(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%apiprivate'
  public static boolean option_api_private(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%buffer' number
  public static boolean option_buffer_size(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%byacc'
  public static boolean option_byacc(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%class' java_type
  public static boolean option_class(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%char'
  public static boolean option_count_char(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%column'
  public static boolean option_count_column(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%line'
  public static boolean option_count_line(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_ctor_arg(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%cup'
  public static boolean option_cup(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%cupdebug'
  public static boolean option_cup_debug(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%cupsym' java_type
  public static boolean option_cup_sym(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%debug'
  public static boolean option_debug(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_eof(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%eofclose' ['false']
  public static boolean option_eof_close(SyntaxTreeBuilder builder, int level) {
  ...
  // ['false']
  private static boolean option_eof_close_1(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_eof_throw(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean option_eof_throw_0(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean option_eof_throw_1(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_eof_val(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%extends' java_type
  public static boolean option_extends(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%final'
  public static boolean option_final(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%full' | '%8bit'
  public static boolean option_full(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%function' id
  public static boolean option_function(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%caseless' | '%ignorecase'
  public static boolean option_ignore_case(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_implements(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%include' user_value
  public static boolean option_include(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_init(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_init_throw(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean option_init_throw_0(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean option_init_throw_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%integer' | '%int'
  public static boolean option_integer(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%intwrap'
  public static boolean option_intwrap(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%notunix' | '%yyeof'
  public static boolean option_obsolete(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%public'
  public static boolean option_public(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%scanerror' java_type
  public static boolean option_scan_error(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%standalone'
  public static boolean option_standalone(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%switch'
  public static boolean option_switch(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%table'
  public static boolean option_table(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '%type' java_type
  public static boolean option_type(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_unicode(SyntaxTreeBuilder builder, int level) {
  ...
  // [number | version]
  private static boolean option_unicode_1(SyntaxTreeBuilder builder, int level) {
  ...
  // number | version
  private static boolean option_unicode_1_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // <<line '%{'>> java_code <<line '%}'>>
  public static boolean option_user_code(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean option_yylexthrow(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean option_yylexthrow_0(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean option_yylexthrow_1(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean rule(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean rule_0(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean rule_0_1(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // !('{' id '}') '{' rule_group_item + '}'
  static boolean rule_group(SyntaxTreeBuilder builder, int level) {
  ...
  // !('{' id '}')
  private static boolean rule_group_0(SyntaxTreeBuilder builder, int level) {
  ...
  // '{' id '}'
  private static boolean rule_group_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // rule_group_item +
  private static boolean rule_group_2(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // option_include | rule
  static boolean rule_group_item(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean rule_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // '}' | '.' | '<' | '<<EOF>>' | '^'| new_line | atom_group
  private static boolean rule_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean rule_tail(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // '<<EOF>>' action
  static boolean rule_tail1(SyntaxTreeBuilder builder, int level) {
  ...
  static boolean rule_tail2(SyntaxTreeBuilder builder, int level) {
  ...
  // ['^']
  private static boolean rule_tail2_0(SyntaxTreeBuilder builder, int level) {
  ...
  // look_ahead?
  private static boolean rule_tail2_2(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // [] new_line '%%' new_line
  static boolean section_div(SyntaxTreeBuilder builder, int level) {
  ...
  // []
  private static boolean section_div_0(SyntaxTreeBuilder builder, int level) {
    return true;
  }

  /* ********************************************************** */
  // !'%%'
  static boolean section_recover(SyntaxTreeBuilder builder, int level) {
  ...
  //   | '{' id | !new_line id )
  static boolean sequence_op(SyntaxTreeBuilder builder, int level) {
  ...
  //   | char_or_esc | char_class | number | string
  //   | '{' id | !new_line id
  private static boolean sequence_op_0(SyntaxTreeBuilder builder, int level) {
  ...
  // !new_line id
  private static boolean sequence_op_0_10(SyntaxTreeBuilder builder, int level) {
  ...
  // !new_line
  private static boolean sequence_op_0_10_0(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean state_declaration(SyntaxTreeBuilder builder, int level) {
  ...
  // '%state' | '%xstate'
  private static boolean state_declaration_0(SyntaxTreeBuilder builder, int level) {
  ...
  // ((','? !(id '=')) state_definition) *
  private static boolean state_declaration_2(SyntaxTreeBuilder builder, int level) {
  ...
  // (','? !(id '=')) state_definition
  private static boolean state_declaration_2_0(SyntaxTreeBuilder builder, int level) {
  ...
  // ','? !(id '=')
  private static boolean state_declaration_2_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // ','?
  private static boolean state_declaration_2_0_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  // !(id '=')
  private static boolean state_declaration_2_0_0_1(SyntaxTreeBuilder builder, int level) {
  ...
  // id '='
  private static boolean state_declaration_2_0_0_1_0(SyntaxTreeBuilder builder, int level) {
  ...
  // ','?
  private static boolean state_declaration_3(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id
  public static boolean state_definition(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean state_list(SyntaxTreeBuilder builder, int level) {
  ...
  // (',' state_reference) *
  private static boolean state_list_2(SyntaxTreeBuilder builder, int level) {
  ...
  // ',' state_reference
  private static boolean state_list_2_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // id
  public static boolean state_reference(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // !(',' | '>') declaration_recover
  static boolean type_recover(SyntaxTreeBuilder builder, int level) {
  ...
  // !(',' | '>')
  private static boolean type_recover_0(SyntaxTreeBuilder builder, int level) {
  ...
  // ',' | '>'
  private static boolean type_recover_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  /* ********************************************************** */
  // [] java_code
  public static boolean user_code_section(SyntaxTreeBuilder builder, int level) {
  ...
  // []
  private static boolean user_code_section_0(SyntaxTreeBuilder builder, int level) {
    return true;
  }

  /* ********************************************************** */
  // <<anything2 !new_line>>
  public static boolean user_value(SyntaxTreeBuilder builder, int level) {
  ...
  // !new_line
  private static boolean user_value_0_0(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean expression(SyntaxTreeBuilder builder, int level, int priority) {
  ...
  public static boolean expression_0(SyntaxTreeBuilder builder, int level, int priority) {
  ...
  // '(' expression ')'
  public static boolean paren_expression(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean not_expression(SyntaxTreeBuilder builder, int level) {
  ...
  // '!'|'~'
  private static boolean not_expression_0(SyntaxTreeBuilder builder, int level) {
  ...
  // '*' | '+' | '?' | '{' number [ ',' number] '}'
  private static boolean quantifier_expression_0(SyntaxTreeBuilder builder, int level) {
  ...
  // '{' number [ ',' number] '}'
  private static boolean quantifier_expression_0_3(SyntaxTreeBuilder builder, int level) {
  ...
  // [ ',' number]
  private static boolean quantifier_expression_0_3_2(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean class_expression(SyntaxTreeBuilder builder, int level) {
  ...
  // '^'?
  private static boolean class_expression_1(SyntaxTreeBuilder builder, int level) {
  ...
  // (char_class_item (char_class_op char_class_item)* )*
  private static boolean class_expression_2(SyntaxTreeBuilder builder, int level) {
  ...
  // char_class_item (char_class_op char_class_item)*
  private static boolean class_expression_2_0(SyntaxTreeBuilder builder, int level) {
  ...
  private static boolean class_expression_2_0_1(SyntaxTreeBuilder builder, int level) {
  ...
  // char_class_op char_class_item
  private static boolean class_expression_2_0_1_0(SyntaxTreeBuilder builder, int level) {
  ...
  // char_class | '.'
  public static boolean predefined_class_expression(SyntaxTreeBuilder builder, int level) {
  ...
  // '{' macro_reference '}'
  public static boolean macro_ref_expression(SyntaxTreeBuilder builder, int level) {
  ...
  public static boolean literal_expression(SyntaxTreeBuilder builder, int level) {
