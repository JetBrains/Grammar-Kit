...
public class TokenChoice implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // D | A | B
  public static boolean another_three_tokens(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | F
  public static boolean fast_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | C | D | E
  public static boolean five_tokens_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | C | D
  public static boolean four_tokens_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | C
  public static boolean parenthesized_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // P2 | P3 | P0 | P1
  static boolean private_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // D | C | A | B | B | A | C
  public static boolean repeating_tokens_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | S
  public static boolean smart_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | C | D | E | F | G | H | I | J
  public static boolean ten_tokens_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // A | B | C
  public static boolean three_tokens_choice(SyntaxTreeBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // B | A | C
  public static boolean three_tokens_in_another_order(SyntaxTreeBuilder builder_, int level_) {
